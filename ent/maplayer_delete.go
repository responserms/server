...
func (mld *MapLayerDelete) Where(ps ...predicate.MapLayer) *MapLayerDelete {
	mld.mutation.predicates = append(mld.mutation.predicates, ps...)
	return mld
}
...
func (mld *MapLayerDelete) sqlExec(ctx context.Context) (int, error) {
...
func (mldo *MapLayerDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{maplayer.Label}
	default:
		return nil
	}
}
