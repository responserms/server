...
func HasMapType() predicate.Metadata {
	return predicate.Metadata(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(MapTypeTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, true, MapTypeTable, MapTypeColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasMapTypeWith(preds ...predicate.MapType) predicate.Metadata {
	return predicate.Metadata(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
