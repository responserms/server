module github.com/responserms/server
...
require (
	...
	github.com/matryer/drop v0.0.0-20161126195007-3756d1243b95 // indirect
	...
	github.com/responserms/spec v0.0.0-20201216061536-9d9142d9192f
